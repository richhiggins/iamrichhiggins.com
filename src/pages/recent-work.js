...
const RecentWorkPage = () => (
  <Layout>
    ...
    <h2 id="bristol">University of Bristol <a href="#bristol"><img src="/static/noun_link_1797965.svg" style={{height:'1em',verticalAlign:'middle',margin:0}}/></a></h2>
    ...
    <video controls style={{maxWidth:'100%'}}>
      <source type="video/mp4" src="/static/search-course-pages-720p.mp4" />
    </video>
    ...
    <figure>
      <video controls style={{maxWidth:'100%'}}>
        <source type="video/mp4" src="/static/gathercontent-idml-720p.mp4" />
      </video>
    ...
    <h2 id="co-op">Co-op Digital Team <a href="#co-op"><img src="/static/noun_link_1797965.svg" style={{height:'1em',verticalAlign:'middle',margin:0}}/></a></h2>
  <p>Between February 2016 and June 2018, I worked with Co-op Digital, helping overhaul their digital publishing service. </p>
    ...
    <h2 id="vitesse">Vitesse Global Payments <a href="#vitesse"><img src="/static/noun_link_1797965.svg" style={{height:'1em',verticalAlign:'middle',margin:0}}/></a></h2>
