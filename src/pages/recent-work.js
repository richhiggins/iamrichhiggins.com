...
const RecentWorkPage = () => (
  <Layout>
    ...
    <p>We've rapidly prototyped a searchable online prospectus using GatherContent, Contentful, GatsbyJS, Netlify and Algolia.</p>
    ...
    <p>Prospectus course content is produced in GatherContent and then handed off to Contentful to power the prototype website.</p>
  ...
  <p>Between 2016 and 2018, I worked with Co-op Digital, helping overhaul their digital publishing service. </p>
    <p>We worked in a GDS derived agile cross-functional team and iteratively developed a highly performant, decoupled publishing platform which now underpins several of their live websites.</p>
    <p>Technology-wise we built progressivly enhanced web front-ends onto a Python/Django application powered by Contentful and deployed to AWS.</p>
    ...
    <p>The site features bespoke HTML5 video work, CSS/JavaScript based animations and a contact form.</p>
